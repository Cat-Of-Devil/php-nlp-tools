...
class RussianStemmer extends Stemmer
{
     ...
     * @return string
     */
    private /*public*/ function getWordBase($word)
    {
    ...
    private /*public*/ function removeEndings($regex, $region)
    {
